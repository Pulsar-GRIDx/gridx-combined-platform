...
const meter = require("./models/meterPowerModel");
...
router.post('/addRandomSampleData', async (req, res) => {
  ...
  function generateRandomSampleData() {
    return [
      Math.random() * 100,      // Random Voltage (between 0 and 100)
      Math.random() * 10,       // Random Current (between 0 and 10)
      Math.random() * 1000,     // Random Active Power (between 0 and 1000)
      Math.random() * 500,      // Random Reactive Power (between 0 and 500)
      Math.random() * 1500,     // Random Apparent Power (between 0 and 1500)
      Math.random() * 50,       // Random Temperature (between 0 and 50)
      Math.random() * 100,      // Random Frequency (between 0 and 100)
      Math.random(),            // Random Power Factor (between 0 and 1)
